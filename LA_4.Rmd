...
###Recommendation
Our recommendation for a course of action is to conduct studies in the health of the children born to smokers and non smokers as they increase in age. By evaluating the health effects on the children as they get older, we are able to tell more specific information and detail for the effects of smoking during pregnancy. Such information would include a child having better or worse respitory issues such as asthma, or other birth defects that may not appear at birth, but over a longer period of time. 
...
While there was similiraties, there were also a lot of differences. For instance, when comparing the Father's education level for smokers and nonsmokers, you can see that there is higher proportion of education in nonsmokers vs nonsmokers.
